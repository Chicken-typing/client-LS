...
import { MENU_LANGUAGE } from './constant';
        ...
        <ul className="right">
          <li className="language">
            <div className="selected">
              <span className="label _text-sm">ENG</span>
                ...
                <li key={item.name} className="list">
                  {item.src ? (
                    <div className="choices">
                      <Image src={item.src} className="image" objectFit="cover" alt="" />
                      <span>{item.name}</span>
                    </div>
                  ) : (
                    <div className="choices">
          ...
          <li className="monetary">
            <div className="selected">
              <span className="currency">
                <i className="fa-regular fa-dollar-sign fa-xs _icon-hover"></i>
              </span>
              <span className="label _text-sm">USD</span>
              <span className="chevron">
                <i className="fa-thin fa-chevron-down fa-2xs icon _icon-hover -font-icon"></i>
              </span>
            </div>
            <ul className="menu">
              <li className="list">€ EUR</li>
            </ul>
          </li>
        </ul>
      </div>
